...
email_label = Label(window, text='info: ', font=('Courier', 14))
pass_label = Label(window, text='side note: ', font=('Courier', 14))
name = Entry(window, font=('Courier', 14))
email = Entry(window, font=('Courier', 14))
password = Entry(window, show='*', font=('Courier', 14))
submit = Button(window, text='note', command=onsubmit, font=('Courier', 14))
...
email_label2 = Label(window, text='Info: ', font=('Courier', 14))
pass_label2 = Label(window, text='Sidenote: ', font=('Courier', 14))
